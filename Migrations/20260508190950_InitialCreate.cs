        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAmador = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClubeOrigemId = table.Column<int>(type: "int", nullable: true),
                    ClubeDestinoId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transferencias_Clubes_ClubeDestinoId",
                        column: x => x.ClubeDestinoId,
                        principalTable: "Clubes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transferencias_Clubes_ClubeOrigemId",
                        column: x => x.ClubeOrigemId,
                        principalTable: "Clubes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transferencias_ClubeDestinoId",
                table: "Transferencias",
                column: "ClubeDestinoId");

            migrationBuilder.CreateIndex(
                name: "IX_Transferencias_ClubeOrigemId",
                table: "Transferencias",
                column: "ClubeOrigemId");
